...
/* 执行巡检策略 */
const r = Random;
const mockOpenExecPlatformInspection: MockMethod = {
	url: "/iotp/api/open/policyManagement/platform/inspection/exec",
	method: "post",
	response: (body: any) => {
...
export default mockOpenExecPlatformInspection;
