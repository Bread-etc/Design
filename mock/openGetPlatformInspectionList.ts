...
/* 获取巡检策略列表 */
const r = Random;
const mockOpenGetPlatformInspectionList: MockMethod = {
	url: "/iotp/api/open/policyManagement/platform/inspection/list",
	method: "post",
	response: (body: any) => {
...
export default mockOpenGetPlatformInspectionList;
